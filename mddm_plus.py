...
import numpy as np
import math
from modules import CARB,upsample_block,Nonlocal_CA,RK3
...
class Branch2(nn.Module):
    def __init__(self):
        ...
        self.convt_F14a = CARB(64)
        self.convt_F15a = CARB(64)
        # style encode
    ...
    def forward(self, x):
        ...
        convt_F14 = self.convt_F14a(convt_F13)
        convt_F15 = self.convt_F15a(convt_F14)
        #上采样
